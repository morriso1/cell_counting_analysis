...
if os.path.isdir(Path_405) and os.path.isdir(Path_488):
    ...
    DF_405_488.to_excel(WRITER, "IndGuts_AllROIs")
    DF_405_488_Mean.to_excel(WRITER, "IndGuts_AllROIs_Mean")
    DF_405_488_Median.to_excel(WRITER, "IndGuts_AllROIs_Median")
    WRITER.save()

    ## saving to pickle files.
    ST_DF_405_488.to_csv(Exp_Analysis_Name + ".csv")
    ST_DF_405_488_Mean.to_csv(Exp_Analysis_Name + "_mean.csv")
    ST_DF_405_488_Median.to_csv(Exp_Analysis_Name + "_median.csv")
